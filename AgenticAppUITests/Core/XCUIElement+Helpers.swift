...
extension XCUIElement {
    ...
    @discardableResult
    func assertExistence(waiting timeout: TimeInterval = 10.0) -> XCUIElement {
    ...
    @discardableResult
    func assertExistence(waiting timeout: TimeInterval = 10.0, message: String) -> XCUIElement {
    ...
    @discardableResult
    func assertNonExistence(waiting timeout: TimeInterval = 10.0) -> XCUIElement {
