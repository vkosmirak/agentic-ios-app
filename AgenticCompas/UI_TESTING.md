...
Quick reference for writing clean, maintainable UI tests in AgenticCompas.

## Base Test Case

All UI tests should inherit from `AgenticCompasUITestCase`:

```swift
final class MyUITests: AgenticCompasUITestCase {
...
- `continueAfterFailure = false` is handled by `AgenticCompasUITestCase`
