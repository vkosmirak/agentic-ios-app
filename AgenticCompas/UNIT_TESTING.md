...
Quick reference guide for writing unit tests in AgenticCompas.

## File Organization

### Folder Structure
Preserve the same folder structure in the production code:
- `AgenticCompas/Core/Services/...` → `AgenticCompasTests/Core/Services/...`
- `AgenticCompas/Features/Stopwatch/...` → `AgenticCompasTests/Features/Stopwatch/...`
