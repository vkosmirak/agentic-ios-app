...
final class TimeServiceTests: XCTestCase {
    ...
    func testFormattedTime() {
        ...
        let date = Date(timeIntervalSince1970: 1730736000)
    ...
    func testFormattedTimeDifferentTimeZones() {
        // Given
        let date = Date(timeIntervalSince1970: 1733266800) // Fixed date: Dec 3, 2024 12:00:00 UTC
    ...
    func testTimeDifferenceAhead() {
        ...
        // Then
        XCTAssertTrue(difference.contains("ahead"), "New York should be ahead of Los Angeles")
    }
    
    func testTimeDifferenceBehind() {
        // Given
        let sourceTimeZone = TimeZone(identifier: "America/New_York")!
        let targetTimeZone = TimeZone(identifier: "America/Los_Angeles")!
        
        // When
        let difference = timeService.timeDifference(from: sourceTimeZone, to: targetTimeZone)
        
        // Then
        XCTAssertTrue(difference.contains("behind"), "Los Angeles should be behind New York")
    }
}
